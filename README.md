...
## Project Structure
    ...
    ├── crowdbotics_dashboa_31450  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_dashboa_31450`
...
2. Clone this repo and `cd crowdbotics_dashboa_31450`
